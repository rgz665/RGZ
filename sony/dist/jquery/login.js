	...
	function login(){
		$(function(){
			...
			$("#r_login").click(function(){
				...
				$("#t_one2").html("注册").attr("class", "t_one active");
				$("#t_one1").html(`<span>登录</span><i>请完成登录后进行购物车相关操作</i>`).attr("class", "t_one");
				$("#t_one1").click(function(){
					$("#t_one2").html("注册").attr("class", "t_one active");
					$("#t_one1").html(`<span>登录</span>
							<i>请完成登录后进行购物车相关操作</i>`).attr("class", "t_one");
					$(".bottom").css("display", "none");
					$("#bottom1").css("display", "block");
				})
				$("#t_one2").click(function(){
					$("#t_one1").html("登录").attr("class", "t_one active");
					$("#t_one2").html(`<span>注册</span>
